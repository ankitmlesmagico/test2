...
const Header: React.FC<DropdownProps> = ({ brandName }) => {
  ...
  return (
    <div className="w-full flex justify-end bg-white h-12 py-2 px-4">
      <button
      ...
      >
        ...
        <span className="text-[#0F1828] mulish-font text-[12px] font-semibold">
          {brandName}
        </span>
        <svg
      ...
      {isOpen && (
        <div className="absolute right-8 mt-7 w-20 bg-white rounded-md shadow-lg border border-gray-200">
          <button
